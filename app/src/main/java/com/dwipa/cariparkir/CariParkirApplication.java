...
/**
 * Created by Kadek_P on 6/21/2016.
 */
public class CariParkirApplication extends Application {
    RestAdapter adapter;
    ...
    public RestAdapter getLoopBackAdapter() {
        if (adapter == null) {
            ...
            adapter = new RestAdapter(
                    getApplicationContext(), "https://cariparkir.herokuapp.com/api");

            // This boilerplate is required for Lesson Three.
            adapter.getContract().addItem(
                    new RestContractItem("parkings/nearby", "GET"),
                    "parking.nearby");
        }
        return adapter;
    }
